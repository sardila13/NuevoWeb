...
//        this.dispositivo = dispositivo;
    ...
    public AlertaDTO(AlertaEntity e) {
        this.esEmergencia = e.getEsEmergencia();
        this.presionSanguinea = e.getPresionSanguinea();
        this.frecuenciaCardiaca = e.getFrecuenciaCardica();
        this.nivelEstres = e.getNivelEstres();
//        this.dispositivo = dispositivo;
        this.tipo = e.getTipo();
