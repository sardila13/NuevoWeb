...
public class HospitalDTO
{
    ...
    public HospitalDTO(HospitalEntity e)
    {
        this.nombre = e.getNombre();
        
        List<DispositivoDTO> listaDispositivos = new ArrayList<>();
        
        for(DispositivoEntity d : e.getDispositivos()){
            listaDispositivos.add(new DispositivoDTO(d));
        }
        
        List<PacienteDTO> listaPacientes = new ArrayList<>();
        
        for(PacienteEntity p : e.getPacientes()){
            listaPacientes.add(new PacienteDTO(p));
        }
