...
public class HistorialDTO 
{
    ...
    public HistorialDTO(HistorialEntity entidad) {
         this.paciente = new PacienteDTO(entidad.getPaciente());
        
        List<AlertaDTO> alertas = new ArrayList<>();
        List<AlertaEntity> alertasEntidades = entidad.getAlertas();
        for(AlertaEntity a : alertasEntidades){
            alertas.add(new AlertaDTO(a));
        }
         
        this.alertas = alertas;
        
        this.tratamientos = entidad.getTratamientos();
        
        this.examenes = entidad.getExamenes();
    }
