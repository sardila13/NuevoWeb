...
public class MedicoResources 
{
    ...
    {
        return new ConsejoDTO(medicoLogic.enviarConsejo(idPaciente,consejo.toEntity()));
    ...
    {
        return new ConfiguracionDTO(medicoLogic.configurarMarcapasos(idDispositivo,config.toEntity()));
