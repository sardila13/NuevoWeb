...
public class DispositivoDTO {
    ...
    DispositivoDTO(DispositivoEntity d) {
        paciente = new PacienteDTO(d.getPaciente());
        hospital = new HospitalDTO(d.getHospital());
        configuracion = new ConfiguracionDTO(d.getConfiguracion());
        
        List<AlertaDTO> lista = new ArrayList<>();
        for(AlertaEntity a : d.getAlertas()){
